...
const RatingSection = () => {
  return (
    <div className="w-full flex flex-row mx-auto justify-around items-center gap-4 my-4">
      <div className="w-full sm:w-1/2 lg:w-1/3 flex flex-col p-4 shadow-md bg-green-50 rounded-lg items-center ">
      ...
      <div className="w-full sm:w-1/2 lg:w-1/3 flex flex-col items-center p-4 shadow-md bg-blue-50 rounded-lg items-center">
