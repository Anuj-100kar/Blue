  ...
  return (
     <div className="flex-1 bg-white rounded-xl shadow-md p-6 ">
          ...
          <div className='flex flex-1 items-center gap-4 mb-6'>
                ...
                <button className='bg-blue-800 text-white px-3 py-1 rounded-md'>Upload Logo</button>
                <button className='border border-blue-800 text-blue-700 rounded-md px-3 py-1'>Delete</button>
          </div>
